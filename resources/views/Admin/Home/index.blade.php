...
<div class="main-wrapper">
    ...
    <div class="hero-slider hero-slider-one">
        ...
        <div class="single-slide" style="background-image: url(assets/images/slider/slider-bg-2.jpg)">
            <!-- Hero Content One Start -->
            <div class="hero-content-one container">
                <div class="row">
                    <div class="col"> 
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="single-banner-two mt--30">
                        <a href="shop.html"><img src="assets/images/banner/bg1.jpg" alt=""></a>
                    </div>
                    <!-- single-banner end -->
                </div>
                <div class="col-lg-6 col-md-6">
                    <!-- single-banner start -->
                    <div class="single-banner-two mt--30">
                        <a href="shop.html"><img src="assets/images/banner/bg2.jpg" alt=""></a>
                    </div>
                    <!-- single-banner end -->
                </div>
            </div>
