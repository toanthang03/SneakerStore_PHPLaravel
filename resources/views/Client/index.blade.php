                ...
                <div class="col-lg-6 offset-lg-6">
                    ...
                    <div class="deals-product-active">
                        <div class="daily-deals-wrap">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="product-details.html"><img src="{{ asset('Client/assets/images/product/1.jpg') }}" alt=""></a>
                        ...
                        <div class="daily-deals-wrap">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="product-details.html"><img src="{{ asset('Client/assets/images/product/3.jpg') }}" alt=""></a>
                                    <span class="label-product label-new">new</span>
            ...
            <div class="product-wrapper">
                <div class="product-slider">
                    ...
                    <div class="col-12">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="{{ asset('Client/assets/images/product/7.jpg') }}" alt=""></a>
                                <span class="label-product label-new">new</span>
                                <span class="label-product label-sale">-7%</span>
                                <div class="quick_view">
                                    <a href="#" title="quick view" class="quick-view-btn" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fa fa-search"></i></a>
                    ...
                    <div class="col-12">
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="product-details.html"><img src="{{ asset('Client/assets/images/product/9.jpg') }}" alt=""></a>
                                <span class="label-product label-new">new</span>
                                <span class="label-product label-sale">-7%</span>
                                <div class="quick_view">
                                    <a href="#" title="quick view" class="quick-view-btn" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fa fa-search"></i></a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="single-banner-two mt--30">
                        <a href="shop.html"><img src="{{ asset('Client/assets/images/banner/bg1.jpg') }}" alt=""></a>
                    </div>
                    <!-- single-banner end -->
                </div>
                <div class="col-lg-6 col-md-6">
                    <!-- single-banner start -->
                    <div class="single-banner-two mt--30">
                        <a href="shop.html"><img src="{{ asset('Client/assets/images/banner/bg2.jpg') }}" alt=""></a>
                    </div>
                    <!-- single-banner end -->
                </div>
            </div>
